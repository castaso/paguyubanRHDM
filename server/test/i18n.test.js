...
const pageSource = fs
  ...
  .map((f) => read(f))
  .join("\n");
const jsSource = ["assets/app.js", "assets/auth.js", "assets/lang.js", "assets/supabase-auth.js", "assets/data.js", "assets/i18n-content.js", "assets/nav.js", "assets/motion.js", "assets/catalog.js"]
  .map(read)
  .join("\n");
